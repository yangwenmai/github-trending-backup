...
#### ruby
* [atech/postal (6,414s/239f)](https://github.com/atech/postal) : 📨 A fully featured open source mail delivery platform for incoming & outgoing e-mail
* [rapid7/metasploit-framework (8,414s/5,191f)](https://github.com/rapid7/metasploit-framework) : Metasploit Framework
...
* [sinatra/sinatra (9,284s/1,680f)](https://github.com/sinatra/sinatra) : Classy web-development dressed in a DSL (official / canonical repo)
...
* [yandex/gixy (2,697s/79f)](https://github.com/yandex/gixy) : Nginx configuration static analyzer
...
* [drduh/macOS-Security-and-Privacy-Guide (11,177s/676f)](https://github.com/drduh/macOS-Security-and-Privacy-Guide) : A practical guide to securing macOS.
...
* [onejgordon/flow-dashboard (747s/45f)](https://github.com/onejgordon/flow-dashboard) : A goal, task & habit tracker + personal dashboard to focus on what matters
...
#### swift
* [kishikawakatsumi/SpreadsheetView (667s/26f)](https://github.com/kishikawakatsumi/SpreadsheetView) : Full configurable spreadsheet view user interfaces for iOS applications. With this framework, you can easily create complex layouts like schedule, gantt chart or timetable as if you are using Excel.
* [Nonchalant/AppIcon (224s/13f)](https://github.com/Nonchalant/AppIcon) : AppIcon generates *.appiconset contains each resolution image for iOS
...
#### javascript
* [getinsomnia/insomnia (2,361s/67f)](https://github.com/getinsomnia/insomnia) : The most intuitive cross-platform REST API Client 😴
...
* [vuejs/vue (53,341s/7,191f)](https://github.com/vuejs/vue) : A progressive, incrementally-adoptable JavaScript framework for building UI on the web.
...
* [acdlite/recompose (5,091s/307f)](https://github.com/acdlite/recompose) : A React utility belt for function components and higher-order components.
...
* [facebook/react (66,611s/12,342f)](https://github.com/facebook/react) : A declarative, efficient, and flexible JavaScript library for building user interfaces.
* [btford/write-good (2,841s/135f)](https://github.com/btford/write-good) : Naive linter for English prose
* [getify/You-Dont-Know-JS (58,388s/9,525f)](https://github.com/getify/You-Dont-Know-JS) : A book series on JavaScript. @YDKJS on twitter.
* [d3/d3 (64,315s/16,857f)](https://github.com/d3/d3) : Bring data to life with SVG, Canvas and HTML. 📊📈🎉
* [twbs/bootstrap (110,503s/50,867f)](https://github.com/twbs/bootstrap) : The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
...
* [socketio/socket.io (32,726s/6,243f)](https://github.com/socketio/socket.io) : Realtime application framework (Node.JS server)
