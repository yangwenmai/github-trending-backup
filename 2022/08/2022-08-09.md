...
21. [Nemo1870/sql-parse (0s/0f)](https://github.com/Nemo1870/sql-parse) : 
...
25. [Swofty-Developments/AtlasRedisAPI (0s/0f)](https://github.com/Swofty-Developments/AtlasRedisAPI) : Blazingly fast multi-purpose Redis API based on Jedis. Used and maintained by Atlas Network.
...
9. [reduplicated/Cloudstream (0s/0f)](https://github.com/reduplicated/Cloudstream) : 
...
12. [vfsfitvnm/ViMusic (0s/0f)](https://github.com/vfsfitvnm/ViMusic) : A Jetpack Compose Android application for streaming music from YouTube Music.
13. [libre-tube/LibreTube (0s/0f)](https://github.com/libre-tube/LibreTube) : An alternative YouTube front end, for Android.
...
20. [revanced/revanced-patcher (0s/0f)](https://github.com/revanced/revanced-patcher) : 💉 Patcher used by ReVanced
...
24. [Swordfish90/Lemuroid (0s/0f)](https://github.com/Swordfish90/Lemuroid) : All in one emulator on Android!
