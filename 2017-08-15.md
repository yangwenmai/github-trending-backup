...
#### go
* [alexellis/faas (2,843s/167f)](https://github.com/alexellis/faas) : 🐳 Functions as a Service - a serverless framework for Docker & Kubernetes
* [apex/up (2,399s/65f)](https://github.com/apex/up) : Deploy infinitely scalable serverless apps, apis, and sites in seconds.
* [awslabs/aws-sam-local (385s/18f)](https://github.com/awslabs/aws-sam-local) : AWS SAM Local 🐿 is a CLI tool for local development and testing of Serverless applications
* [golang/go (31,004s/4,174f)](https://github.com/golang/go) : The Go programming language
* [kubernetes/kubernetes (25,872s/9,218f)](https://github.com/kubernetes/kubernetes) : Production-Grade Container Scheduling and Management
...
* [google/cloudprober (86s/6f)](https://github.com/google/cloudprober) : An active monitoring software to detect failures before your customers do.
...
* [golang/dep (4,115s/236f)](https://github.com/golang/dep) : Go dependency management tool
* [gogits/gogs (20,418s/2,346f)](https://github.com/gogits/gogs) : Gogs is a painless self-hosted Git service.
* [segmentio/chamber (77s/0f)](https://github.com/segmentio/chamber) : CLI for managing secrets
* [workanator/go-floc (59s/0f)](https://github.com/workanator/go-floc) : Floc: Orchestrate goroutines with ease.
...
* [prometheus/prometheus (11,058s/1,238f)](https://github.com/prometheus/prometheus) : The Prometheus monitoring system and time series database.
...
#### objective-c
* [AAChartModel/AAChartKit (501s/85f)](https://github.com/AAChartModel/AAChartKit) : An elegant and friendly chart library for iOS developer
...
* [WillkYang/Y_KLine (907s/240f)](https://github.com/WillkYang/Y_KLine) : iOS专业K线第一版：K线主副图、趋势图、成交量、滚动、放大缩小、MACD、KDJ等
...
* [rs/SDWebImage (18,334s/4,907f)](https://github.com/rs/SDWebImage) : Asynchronous image downloader with cache support as a UIImageView category
* [TextureGroup/Texture (1,718s/177f)](https://github.com/TextureGroup/Texture) : Smooth asynchronous user interfaces for iOS apps.
* [GeniusBrother/HZExtend (345s/79f)](https://github.com/GeniusBrother/HZExtend) : A useful collection of iOS components.
...
* [WenchaoD/FSCalendar (4,874s/841f)](https://github.com/WenchaoD/FSCalendar) : A fully customizable iOS calendar library, compatible with Objective-C and Swift
* [China131/JHChart (379s/112f)](https://github.com/China131/JHChart) : 
...
* [wangmchn/WMPageController (1,661s/356f)](https://github.com/wangmchn/WMPageController) : An easy solution to page controllers like NetEase News
...
* [asiosldh/BMDragCellCollectionView (333s/49f)](https://github.com/asiosldh/BMDragCellCollectionView) : 支付宝类似的 UICollectionViewCell 长按拖拽重排, Drag,DragAndDrop,LongPressGestures,LongPressGesturesDrag,LongPressGesturesDragAndDrop,UICollectionView,UICollectionViewCell,UICollectionViewCellDrag,UICollectionViewCellDrag,UICollectionViewCellRearrangement,UICollectionViewRearrangement,iOS,Objective-C,OC,Gestures,
* [material-components/material-components-ios (1,436s/176f)](https://github.com/material-components/material-components-ios) : Modular and customizable Material Design UI components for iOS
...
#### javascript
* [aksakalli/gtop (2,558s/74f)](https://github.com/aksakalli/gtop) : System monitoring dashboard for terminal
* [notifme/notifme-sdk (985s/31f)](https://github.com/notifme/notifme-sdk) : A Node.js library to send all kinds of transactional notifications.
* [atlassian/react-beautiful-dnd (1,180s/31f)](https://github.com/atlassian/react-beautiful-dnd) : Beautiful, accessible drag and drop for lists with React.js
* [ai/nanoid (1,930s/49f)](https://github.com/ai/nanoid) : A tiny, secure URL-friendly unique string ID generator for JavaScript
* [denysdovhan/wtfjs (7,731s/393f)](https://github.com/denysdovhan/wtfjs) : A list of funny and tricky JavaScript examples
* [twbs/bootstrap (113,928s/53,088f)](https://github.com/twbs/bootstrap) : The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
* [vuejs/vue (63,351s/9,050f)](https://github.com/vuejs/vue) : A progressive, incrementally-adoptable JavaScript framework for building UI on the web.
* [standard-things/esm (1,015s/12f)](https://github.com/standard-things/esm) : ES modules in Node today!
* [rtfeldman/seamless-immutable (3,722s/152f)](https://github.com/rtfeldman/seamless-immutable) : Immutable data structures for JavaScript which are backwards-compatible with normal JS Arrays and Objects.
* [facebookincubator/create-react-app (32,585s/5,198f)](https://github.com/facebookincubator/create-react-app) : Create React apps with no build configuration.
* [facebook/react (73,475s/13,824f)](https://github.com/facebook/react) : A declarative, efficient, and flexible JavaScript library for building user interfaces.
* [toddmotto/public-apis (25,917s/2,158f)](https://github.com/toddmotto/public-apis) : A collective list of public JSON APIs for use in web development.
...
* [getify/You-Dont-Know-JS (65,349s/11,033f)](https://github.com/getify/You-Dont-Know-JS) : A book series on JavaScript. @YDKJS on twitter.
...
* [mzabriskie/axios (25,046s/1,592f)](https://github.com/mzabriskie/axios) : Promise based HTTP client for the browser and node.js
* [nodejs/node (38,113s/7,551f)](https://github.com/nodejs/node) : Node.js JavaScript runtime ✨🐢🚀✨
* [wearehive/project-guidelines (10,117s/783f)](https://github.com/wearehive/project-guidelines) : A set of best practices for JavaScript projects
...
* [FezVrasta/popper.js (5,284s/246f)](https://github.com/FezVrasta/popper.js) : A kickass library to manage your poppers
* [GoogleChrome/lighthouse (10,039s/696f)](https://github.com/GoogleChrome/lighthouse) : Auditing, performance metrics, and best practices for Progressive Web Apps
...
#### python
* [vahidk/EffectiveTensorflow (3,199s/191f)](https://github.com/vahidk/EffectiveTensorflow) : TensorFlow tutorials and best practices.
* [deepmind/pysc2 (2,036s/179f)](https://github.com/deepmind/pysc2) : StarCraft II Learning Environment
* [OmkarPathak/pygorithm (2,249s/164f)](https://github.com/OmkarPathak/pygorithm) : A Python module for learning all major algorithms
* [jiajunhuang/blog (237s/31f)](https://github.com/jiajunhuang/blog) : Jiajun's Blog
* [tensorflow/models (19,871s/8,551f)](https://github.com/tensorflow/models) : Models built with TensorFlow
* [honeynet/droidbot (178s/32f)](https://github.com/honeynet/droidbot) : A lightweight test input generator for Android. Similar to Monkey, but with more intelligence and cool features!
* [m4ll0k/Spaghetti (80s/20f)](https://github.com/m4ll0k/Spaghetti) : Spaghetti - Web Application Security Scanner
* [apache/incubator-superset (15,366s/2,235f)](https://github.com/apache/incubator-superset) : Apache Superset (incubating) is a modern, enterprise-ready business intelligence web application
* [fchollet/keras (18,608s/6,696f)](https://github.com/fchollet/keras) : Deep Learning library for Python. Runs on TensorFlow, Theano, or CNTK.
* [aaronduino/asciidots (667s/14f)](https://github.com/aaronduino/asciidots) : AsciiDots - The result of combining ascii art, electrical engineering, and programming
...
* [openai/gym (6,679s/1,471f)](https://github.com/openai/gym) : A toolkit for developing and comparing reinforcement learning algorithms.
* [vinta/awesome-python (37,415s/7,068f)](https://github.com/vinta/awesome-python) : A curated list of awesome Python frameworks, libraries, software and resources
...
* [chiphuyen/stanford-tensorflow-tutorials (2,339s/1,066f)](https://github.com/chiphuyen/stanford-tensorflow-tutorials) : This repository contains code examples for the course CS 20SI: TensorFlow for Deep Learning Research.
...
* [donnemartin/system-design-primer (18,740s/2,014f)](https://github.com/donnemartin/system-design-primer) : Learn how to design large-scale systems. Prep for the system design interview. Includes Anki flashcards.
...
* [ageitgey/face_recognition (5,577s/847f)](https://github.com/ageitgey/face_recognition) : The world's simplest facial recognition api for Python and the command line
...
#### ruby
* [fastlane/fastlane (17,493s/2,702f)](https://github.com/fastlane/fastlane) : 🚀 The easiest way to automate building and releasing your iOS and Android apps
...
* [seejohnrun/ice_cube (1,603s/252f)](https://github.com/seejohnrun/ice_cube) : Ruby Date Recurrence Library - Allows easy creation of recurrence rules and fast querying
* [jekyll/jekyll (30,751s/6,854f)](https://github.com/jekyll/jekyll) : 🌐 Jekyll is a blog-aware, static site generator in Ruby
* [Homebrew/brew (8,374s/2,143f)](https://github.com/Homebrew/brew) : 🍺 The missing package manager for macOS
* [discourse/discourse (22,379s/5,718f)](https://github.com/discourse/discourse) : A platform for community discussion. Free, open, simple.
...
#### swift
* [AppliKeySolutions/PandoraPlayer (369s/15f)](https://github.com/AppliKeySolutions/PandoraPlayer) : A lightweight music player for iOS, based on AudioKit and completely written in Swift.
* [oabdelkarim/ARPaint (215s/19f)](https://github.com/oabdelkarim/ARPaint) : Draw with bare fingers in the air using ARKit
* [shoheiyokoyama/Gemini (1,563s/48f)](https://github.com/shoheiyokoyama/Gemini) : Gemini is rich scroll based animation framework for iOS, written in Swift.
* [ProjectDent/ARKit-CoreLocation (2,081s/137f)](https://github.com/ProjectDent/ARKit-CoreLocation) : Combines the high accuracy of AR with the scale of GPS data.
* [yysskk/SwipeMenuViewController (61s/5f)](https://github.com/yysskk/SwipeMenuViewController) : Swipable tab and menu View and ViewController.
* [Kawoou/AnyDate (70s/5f)](https://github.com/Kawoou/AnyDate) : Swift Date & Time API inspired from Java 8 DateTime API.
* [devxoul/UICollectionViewFlexLayout (93s/2f)](https://github.com/devxoul/UICollectionViewFlexLayout) : A drop-in replacement for UICollectionViewFlowLayout
...
* [Alamofire/Alamofire (24,787s/4,318f)](https://github.com/Alamofire/Alamofire) : Elegant HTTP Networking in Swift
...
* [Ramotion/animated-tab-bar (7,628s/1,013f)](https://github.com/Ramotion/animated-tab-bar) : RAMAnimatedTabBarController is a Swift UI module for adding animation to tabbar items. Made by @Ramotion
* [dkhamsing/open-source-ios-apps (13,997s/2,478f)](https://github.com/dkhamsing/open-source-ios-apps) : 📱 Collaborative List of Open-Source iOS Apps
* [shadowsocks/ShadowsocksX-NG (5,044s/1,888f)](https://github.com/shadowsocks/ShadowsocksX-NG) : Next Generation of ShadowsocksX
* [lkzhao/Hero (10,088s/682f)](https://github.com/lkzhao/Hero) : Elegant transition library for iOS & tvOS
* [BeauNouvelle/SimpleCheckbox (46s/5f)](https://github.com/BeauNouvelle/SimpleCheckbox) : A simple Checkbox
* [vsouza/awesome-ios (21,168s/3,578f)](https://github.com/vsouza/awesome-ios) : A curated list of awesome iOS ecosystem, including Objective-C and Swift Projects
* [lhc70000/iina (7,266s/523f)](https://github.com/lhc70000/iina) : The modern video player for macOS.
* [olucurious/awesome-arkit (1,509s/100f)](https://github.com/olucurious/awesome-arkit) : A curated list of awesome ARKit projects and resources. Feel free to contribute!
...
* [ReactiveX/RxSwift (10,372s/1,585f)](https://github.com/ReactiveX/RxSwift) : Reactive Programming in Swift
...
* [SnapKit/SnapKit (10,480s/1,059f)](https://github.com/SnapKit/SnapKit) : A Swift Autolayout DSL for iOS & OS X
* [Moya/Moya (6,714s/736f)](https://github.com/Moya/Moya) : Network abstraction layer written in Swift.
