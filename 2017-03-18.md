...
#### swift
* [willowtreeapps/spruce-ios (692s/30f)](https://github.com/willowtreeapps/spruce-ios) : Swift library for choreographing animations on the screen.
...
* [marty-suzuki/ReverseExtension (289s/15f)](https://github.com/marty-suzuki/ReverseExtension) : A UITableView extension that enables cell insertion from the bottom of a table view.
...
* [pinterest/plank (38s/1f)](https://github.com/pinterest/plank) : A tool for generating immutable model objects
...
* [lbryio/lbry (955s/43f)](https://github.com/lbryio/lbry) : A fully decentralized network for distributing data
...
* [youfou/wxpy (1,204s/181f)](https://github.com/youfou/wxpy) : 微信机器人 / 优雅的微信个人号API
* [scrapy/scrapy (19,194s/5,147f)](https://github.com/scrapy/scrapy) : Scrapy, a fast high-level web crawling & scraping framework for Python.
...
* [tensorflow/models (12,532s/4,096f)](https://github.com/tensorflow/models) : Models built with TensorFlow
...
* [vinta/awesome-python (30,677s/5,833f)](https://github.com/vinta/awesome-python) : A curated list of awesome Python frameworks, libraries, software and resources
...
* [sangaline/advanced-web-scraping-tutorial (91s/12f)](https://github.com/sangaline/advanced-web-scraping-tutorial) : The Zipru scraper developed in the Advanced Web Scraping Tutorial.
* [google/python-fire (4,895s/203f)](https://github.com/google/python-fire) : Python Fire is a library for automatically generating command line interfaces (CLIs) from absolutely any Python object.
...
* [yunjey/pytorch-tutorial (1,219s/165f)](https://github.com/yunjey/pytorch-tutorial) : tutorial for researchers to learn deep learning with pytorch
...
* [rg3/youtube-dl (24,525s/4,710f)](https://github.com/rg3/youtube-dl) : Command-line program to download videos from YouTube.com and other video sites
...
* [rails/rails (34,917s/14,248f)](https://github.com/rails/rails) : Ruby on Rails
...
#### go
* [mholt/caddy (10,862s/713f)](https://github.com/mholt/caddy) : Fast, cross-platform HTTP/2 web server with automatic HTTPS
...
* [spf13/hugo (15,714s/2,287f)](https://github.com/spf13/hugo) : A Fast and Flexible Static Site Generator built with love in GoLang
...
* [kubernetes/kubernetes (21,538s/7,410f)](https://github.com/kubernetes/kubernetes) : Production-Grade Container Scheduling and Management
...
* [jessesquires/JSQMessagesViewController (10,074s/2,396f)](https://github.com/jessesquires/JSQMessagesViewController) : An elegant messages UI library for iOS
...
#### javascript
* [netlify/netlify-cms (1,438s/121f)](https://github.com/netlify/netlify-cms) : A CMS for Static Site Generators
* [aweary/react-perimeter (397s/8f)](https://github.com/aweary/react-perimeter) : Create an invisible perimeter around an element and respond when its breached.
* [freeCodeCamp/freeCodeCamp (245,649s/10,155f)](https://github.com/freeCodeCamp/freeCodeCamp) : The https://freeCodeCamp.com open source codebase and curriculum. Learn to code and help nonprofits.
* [vuejs/vue (47,090s/6,102f)](https://github.com/vuejs/vue) : A progressive, incrementally-adoptable JavaScript framework for building UI on the web.
* [react-community/create-react-native-app (2,850s/82f)](https://github.com/react-community/create-react-native-app) : Create a React Native app on any OS with no build config.
...
* [mzabriskie/axios (15,599s/849f)](https://github.com/mzabriskie/axios) : Promise based HTTP client for the browser and node.js
* [facebookincubator/create-react-app (22,873s/2,810f)](https://github.com/facebookincubator/create-react-app) : Create React apps with no build configuration.
...
* [d3/d3 (61,679s/16,375f)](https://github.com/d3/d3) : Bring data to life with SVG, Canvas and HTML. 📊📈🎉
...
* [zeit/next.js (9,754s/549f)](https://github.com/zeit/next.js) : Framework for server-rendered React apps
* [airbnb/javascript (49,132s/9,438f)](https://github.com/airbnb/javascript) : JavaScript Style Guide
