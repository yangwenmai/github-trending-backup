...
#### Go
1. [cli/cli (9,134s/0f)](https://github.com/cli/cli) : GitHub’s official command line tool
...
11. [jarun/nnn (8,144s/0f)](https://github.com/jarun/nnn) : n³ The missing terminal file manager for X.
...
#### Python
1. [facebookresearch/detr (2,232s/0f)](https://github.com/facebookresearch/detr) : End-to-End Object Detection with Transformers
...
12. [python-poetry/poetry (10,762s/0f)](https://github.com/python-poetry/poetry) : Python dependency management and packaging made easy.
...
19. [LupusLeaks/EasyFN (6,788s/0f)](https://github.com/LupusLeaks/EasyFN) : (UPDATING PLEASE WAIT) With EasyFNBot you can easily create you own Fortnite Lobby Bot in less then 5 minutes which will be online forever!
...
#### JavaScript
1. [mertJF/tailblocks (1,682s/0f)](https://github.com/mertJF/tailblocks) : 🎉 Ready-to-use Tailwind CSS blocks.
2. [pikapkg/create-snowpack-app (283s/0f)](https://github.com/pikapkg/create-snowpack-app) : CSA - Get started with the fastest dev environment available.
...
4. [goldbergyoni/nodebestpractices (45,264s/0f)](https://github.com/goldbergyoni/nodebestpractices) : ✅ The Node.js best practices list (May 2020)
5. [trekhleb/javascript-algorithms (72,071s/0f)](https://github.com/trekhleb/javascript-algorithms) : 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
6. [airbnb/javascript (96,244s/0f)](https://github.com/airbnb/javascript) : JavaScript Style Guide
7. [pikapkg/snowpack (8,488s/0f)](https://github.com/pikapkg/snowpack) : ☶ A faster dev environment for modern web apps.
8. [yemount/pose-animator (4,986s/0f)](https://github.com/yemount/pose-animator) : 
9. [supabase/supabase (1,166s/0f)](https://github.com/supabase/supabase) : Website, docs, and client libraries. Follow to stay updated about our public Beta.
...
6. [pshihn/rough-notation (2,150s/0f)](https://github.com/pshihn/rough-notation) : Create and animate hand-drawn annotations on a web page
...
20. [tailwindcss/tailwindcss (23,512s/0f)](https://github.com/tailwindcss/tailwindcss) : A utility-first CSS framework for rapid UI development.
