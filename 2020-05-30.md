...
#### Go
1. [cli/cli (9,133s/0f)](https://github.com/cli/cli) : GitHub’s official command line tool
2. [zyedidia/micro (13,681s/0f)](https://github.com/zyedidia/micro) : A modern and intuitive terminal-based text editor
3. [hashicorp/terraform (22,172s/0f)](https://github.com/hashicorp/terraform) : Terraform enables you to safely and predictably create, change, and improve infrastructure. It is an open source tool that codifies APIs into declarative configuration files that can be shared amongst team members, treated as code, edited, reviewed, and versioned.
4. [golang/protobuf (6,669s/0f)](https://github.com/golang/protobuf) : Go support for Google's protocol buffers
5. [hashicorp/consul (19,274s/0f)](https://github.com/hashicorp/consul) : Consul is a distributed, highly available, and data center aware solution to connect and configure applications across dynamic, distributed infrastructure.
...
19. [kubernetes/kubernetes (66,552s/0f)](https://github.com/kubernetes/kubernetes) : Production-Grade Container Scheduling and Management
...
2. [rust-lang/rust (45,172s/0f)](https://github.com/rust-lang/rust) : Empowering everyone to build reliable and efficient software.
...
4. [libra/libra (14,465s/0f)](https://github.com/libra/libra) : Libra’s mission is to enable a simple global payment system and financial infrastructure that empowers billions of people.
5. [xi-editor/xi-editor (17,793s/0f)](https://github.com/xi-editor/xi-editor) : A modern editor with a backend written in Rust.
...
9. [rust-lang/rust-clippy (4,673s/0f)](https://github.com/rust-lang/rust-clippy) : A bunch of lints to catch common mistakes and improve your Rust code
10. [RustPython/RustPython (5,316s/0f)](https://github.com/RustPython/RustPython) : A Python Interpreter written in Rust
11. [gleam-lang/gleam (1,886s/0f)](https://github.com/gleam-lang/gleam) : ⭐️ A statically typed language for the Erlang VM
12. [SergioBenitez/Rocket (9,861s/0f)](https://github.com/SergioBenitez/Rocket) : A web framework for Rust.
13. [rust-lang/rustlings (9,199s/0f)](https://github.com/rust-lang/rustlings) : 🦀 Small exercises to get you used to reading and writing Rust code!
14. [casey/just (1,653s/0f)](https://github.com/casey/just) : 🤖 Just a command runner
15. [paritytech/polkadot (851s/0f)](https://github.com/paritytech/polkadot) : Polkadot Node Implementation
...
24. [hyperium/hyper (6,349s/0f)](https://github.com/hyperium/hyper) : An HTTP library for Rust
...
#### Python
1. [facebookresearch/detr (2,230s/0f)](https://github.com/facebookresearch/detr) : End-to-End Object Detection with Transformers
2. [eriklindernoren/ML-From-Scratch (16,238s/0f)](https://github.com/eriklindernoren/ML-From-Scratch) : Machine Learning From Scratch. Bare bones NumPy implementations of machine learning models and algorithms with a focus on accessibility. Aims to cover everything from linear regression to deep learning.
3. [willmcgugan/rich (6,188s/0f)](https://github.com/willmcgugan/rich) : Rich is a Python library for rich text and beautiful formatting in the terminal.
...
7. [mlflow/mlflow (6,576s/0f)](https://github.com/mlflow/mlflow) : Open source platform for the machine learning lifecycle
...
10. [tiangolo/fastapi (14,346s/0f)](https://github.com/tiangolo/fastapi) : FastAPI framework, high performance, easy to learn, fast to code, ready for production
...
12. [python-poetry/poetry (10,761s/0f)](https://github.com/python-poetry/poetry) : Python dependency management and packaging made easy.
...
15. [plotly/dash (12,054s/0f)](https://github.com/plotly/dash) : Analytical Web Apps for Python, R, Julia, and Jupyter. No JavaScript Required.
...
20. [jina-ai/jina (468s/0f)](https://github.com/jina-ai/jina) : Jina is the cloud-native neural search framework powered by state-of-the-art AI and deep learning
...
22. [anandpawara/Real_Time_Image_Animation (1,308s/0f)](https://github.com/anandpawara/Real_Time_Image_Animation) : The Project is real time application in opencv using first order model
...
2. [Genymobile/scrcpy (31,160s/0f)](https://github.com/Genymobile/scrcpy) : Display and control your Android device
...
4. [dbanay/Smalltalk (444s/0f)](https://github.com/dbanay/Smalltalk) : By the Bluebook implementation of Smalltalk-80
...
7. [openresty/openresty (8,479s/0f)](https://github.com/openresty/openresty) : High Performance Web Platform Based on Nginx and LuaJIT
...
13. [aws/amazon-freertos (1,977s/0f)](https://github.com/aws/amazon-freertos) : IoT operating system for microcontrollers.
...
#### Java
1. [alibaba/fastjson (21,486s/0f)](https://github.com/alibaba/fastjson) : A fast JSON parser/generator for Java.
2. [doocs/advanced-java (44,000s/0f)](https://github.com/doocs/advanced-java) : 😮 互联网 Java 工程师进阶知识完全扫盲：涵盖高并发、分布式、高可用、微服务、海量数据处理等领域知识，后端同学必看，前端同学也可学习
...
6. [TechEmpower/FrameworkBenchmarks (5,135s/0f)](https://github.com/TechEmpower/FrameworkBenchmarks) : Source for the TechEmpower Framework Benchmarks project
7. [quarkusio/quarkus (4,802s/0f)](https://github.com/quarkusio/quarkus) : Quarkus: Supersonic Subatomic Java.
...
5. [airbnb/lottie-ios (19,665s/0f)](https://github.com/airbnb/lottie-ios) : An iOS library to natively render After Effects vector animations
...
#### Shell
1. [pry0cc/axiom (296s/0f)](https://github.com/pry0cc/axiom) : A dynamic infrastructure toolkit for red teamers and bug bounty hunters!
...
16. [nodesource/distributions (6,856s/0f)](https://github.com/nodesource/distributions) : NodeSource Node.js Binary Distributions
...
19. [LupusLeaks/EasyFN (6,784s/0f)](https://github.com/LupusLeaks/EasyFN) : (UPDATING PLEASE WAIT) With EasyFNBot you can easily create you own Fortnite Lobby Bot in less then 5 minutes which will be online forever!
...
7. [wstyres/Zebra (450s/0f)](https://github.com/wstyres/Zebra) : A Useful Package Manager for iOS
...
3. [nhsx/COVID-19-app-Android-BETA (718s/0f)](https://github.com/nhsx/COVID-19-app-Android-BETA) : Source code of the Beta of the NHS COVID-19 Android app
...
#### Jupyter-Notebook
1. [AliaksandrSiarohin/first-order-model (4,039s/0f)](https://github.com/AliaksandrSiarohin/first-order-model) : This repository contains the source code for the paper First Order Motion Model for Image Animation
...
12. [romeokienzler/TensorFlow (339s/0f)](https://github.com/romeokienzler/TensorFlow) : Project containig related material for my TensorFlow articles
...
20. [pprp/SimpleCVReproduction (124s/0f)](https://github.com/pprp/SimpleCVReproduction) : reproduce the simplest cv work including classification, object detection, segmentation, keypoint detection, tracking etc.
...
24. [jackfrued/Python-100-Days (86,698s/0f)](https://github.com/jackfrued/Python-100-Days) : Python - 100天从新手到大师
...
2. [nndl/nndl.github.io (12,379s/0f)](https://github.com/nndl/nndl.github.io) : 《神经网络与深度学习》 邱锡鹏著 Neural Network and Deep Learning
...
2. [react-hook-form/react-hook-form (10,712s/0f)](https://github.com/react-hook-form/react-hook-form) : 📋 React hooks for forms validation without the hassle (Web + React Native)
...
4. [storybookjs/storybook (48,710s/0f)](https://github.com/storybookjs/storybook) : 📓 UI component dev & test: React, Vue, Angular, React Native, Ember, Web Components & more!
5. [vuejs/vue-next (12,785s/0f)](https://github.com/vuejs/vue-next) : Repo for Vue 3.0 (currently in beta)
6. [pshihn/rough-notation (2,147s/0f)](https://github.com/pshihn/rough-notation) : Create and animate hand-drawn annotations on a web page
7. [angular/angular-cli (23,396s/0f)](https://github.com/angular/angular-cli) : CLI tool for Angular
8. [xFAANG/askql (211s/0f)](https://github.com/xFAANG/askql) : AskQL is a query language that can express any data request
...
20. [nestjs/nest (27,298s/0f)](https://github.com/nestjs/nest) : A progressive Node.js framework for building efficient, scalable, and enterprise-grade server-side applications on top of TypeScript & JavaScript (ES6, ES7, ES8) 🚀
...
22. [cdr/code-server (31,562s/0f)](https://github.com/cdr/code-server) : VS Code in the browser
...
#### JavaScript
1. [mertJF/tailblocks (1,678s/0f)](https://github.com/mertJF/tailblocks) : 🎉 Ready-to-use Tailwind CSS blocks.
2. [pikapkg/create-snowpack-app (282s/0f)](https://github.com/pikapkg/create-snowpack-app) : CSA - Get started with the fastest dev environment available.
3. [gothinkster/realworld (41,651s/0f)](https://github.com/gothinkster/realworld) : "The mother of all demo apps" — Exemplary fullstack Medium.com clone powered by React, Angular, Node, Django, and many more 🏅
4. [goldbergyoni/nodebestpractices (45,263s/0f)](https://github.com/goldbergyoni/nodebestpractices) : ✅ The Node.js best practices list (May 2020)
5. [trekhleb/javascript-algorithms (72,070s/0f)](https://github.com/trekhleb/javascript-algorithms) : 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
6. [airbnb/javascript (96,242s/0f)](https://github.com/airbnb/javascript) : JavaScript Style Guide
7. [pikapkg/snowpack (8,487s/0f)](https://github.com/pikapkg/snowpack) : ☶ A faster dev environment for modern web apps.
8. [yemount/pose-animator (4,985s/0f)](https://github.com/yemount/pose-animator) : 
9. [supabase/supabase (1,165s/0f)](https://github.com/supabase/supabase) : Website, docs, and client libraries. Follow to stay updated about our public Beta.
...
12. [sudheerj/reactjs-interview-questions (6,265s/0f)](https://github.com/sudheerj/reactjs-interview-questions) : List of top 500 ReactJS Interview Questions & Answers....Coding exercise questions are coming soon!!
13. [gatsbyjs/gatsby (44,730s/0f)](https://github.com/gatsbyjs/gatsby) : Build blazing fast, modern apps and websites with React
14. [zarkin404/sweater (531s/0f)](https://github.com/zarkin404/sweater) : 薅🐑毛，做衬衫（最近更新：京东 618 叠蛋糕脚本，非模拟点击，PC 浏览器可运行）
15. [pkalogiros/AudioMass (568s/0f)](https://github.com/pkalogiros/AudioMass) : Free full-featured web-based audio & waveform editing tool
16. [aws/aws-sdk-js (5,991s/0f)](https://github.com/aws/aws-sdk-js) : AWS SDK for JavaScript in the browser and Node.js
...
19. [pomber/didact (2,635s/0f)](https://github.com/pomber/didact) : A DIY guide to build your own React
20. [bigskysoftware/htmx (988s/0f)](https://github.com/bigskysoftware/htmx) : </> htmx - high power tools for HTML
...
22. [moment/moment (44,095s/0f)](https://github.com/moment/moment) : Parse, validate, manipulate, and display dates in javascript.
23. [sveltejs/svelte (34,125s/0f)](https://github.com/sveltejs/svelte) : Cybernetically enhanced web apps
24. [Laravel-Backpack/CRUD (1,583s/0f)](https://github.com/Laravel-Backpack/CRUD) : Build custom admin panels. Fast!
25. [KuroLabs/stegcloak (216s/0f)](https://github.com/KuroLabs/stegcloak) : Hide secrets with invisible characters in plain text securely using passwords 🧙🏻‍♂️⭐
...
4. [bastienwirtz/homer (603s/0f)](https://github.com/bastienwirtz/homer) : A very simple static homepage for your server.
5. [GoogleChrome/web-vitals-extension (1,361s/0f)](https://github.com/GoogleChrome/web-vitals-extension) : A Chrome extension to measure essential metrics for a healthy site
...
10. [StylishThemes/GitHub-Dark (8,162s/0f)](https://github.com/StylishThemes/GitHub-Dark) : Dark GitHub style
...
20. [tailwindcss/tailwindcss (23,511s/0f)](https://github.com/tailwindcss/tailwindcss) : A utility-first CSS framework for rapid UI development.
...
#### Vue
1. [Hunlongyu/ZY-Player (679s/0f)](https://github.com/Hunlongyu/ZY-Player) : ▶️ 跨平台桌面端视频资源播放器.简洁无广告.免费高颜值. 🎞
...
12. [PanJiaChen/vue-element-admin (55,078s/0f)](https://github.com/PanJiaChen/vue-element-admin) : 🎉 A magical vue admin https://panjiachen.github.io/vue-element-admin
