...
#### python
* [vesche/basicRAT (406s/59f)](https://github.com/vesche/basicRAT) : python remote access trojan
...
* [lgandx/PoC (253s/128f)](https://github.com/lgandx/PoC) : Various PoCs
...
* [littlecodersh/ItChat (1,767s/533f)](https://github.com/littlecodersh/ItChat) : A complete and graceful API for Wechat. 微信个人号接口、微信机器人及命令行微信，三十行即可自定义个人号机器人。
...
* [RUB-NDS/PRET (341s/53f)](https://github.com/RUB-NDS/PRET) : Printer Exploitation Toolkit - The tool that made dumpster diving obsolete.
* [tensorflow/models (11,159s/3,205f)](https://github.com/tensorflow/models) : Models built with TensorFlow
...
* [pytorch/pytorch (2,942s/274f)](https://github.com/pytorch/pytorch) : Tensors and Dynamic neural networks in Python with strong GPU acceleration
* [XX-net/XX-Net (12,331s/4,265f)](https://github.com/XX-net/XX-Net) : a web proxy tool
* [sqlmapproject/sqlmap (7,862s/1,837f)](https://github.com/sqlmapproject/sqlmap) : Automatic SQL injection and database takeover tool
...
#### go
* [asciimoo/wuzz (2,747s/72f)](https://github.com/asciimoo/wuzz) : Interactive cli tool for HTTP inspection
...
* [kubernetes/kubernetes (20,354s/6,951f)](https://github.com/kubernetes/kubernetes) : Production-Grade Container Scheduling and Management
...
* [fission/fission (1,352s/54f)](https://github.com/fission/fission) : Fast Serverless Functions for Kubernetes
...
* [gogits/gogs (17,590s/1,968f)](https://github.com/gogits/gogs) : Gogs (Go Git Service) is a painless self-hosted Git service.

#### objective-c
* [airbnb/lottie-ios (4,149s/239f)](https://github.com/airbnb/lottie-ios) : An iOS library to natively render After Effects vector animations
...
* [jekyll/jekyll (28,536s/6,342f)](https://github.com/jekyll/jekyll) : 🌐 Jekyll is a blog-aware, static site generator in Ruby
...
#### javascript
* [freeCodeCamp/freeCodeCamp (229,921s/9,342f)](https://github.com/freeCodeCamp/freeCodeCamp) : The https://freeCodeCamp.com open source codebase and curriculum. Learn to code and help nonprofits.
* [bodymovin/bodymovin (3,859s/225f)](https://github.com/bodymovin/bodymovin) : after effects to html library
...
* [vuejs/vue (41,940s/5,205f)](https://github.com/vuejs/vue) : A progressive, incrementally-adoptable JavaScript framework for building UI on the web.
* [chvin/react-tetris (1,733s/194f)](https://github.com/chvin/react-tetris) : Use React, Redux, Immutable to code Tetris.
* [hackjutsu/Lepton (555s/30f)](https://github.com/hackjutsu/Lepton) : An AWESOME desktop Gist client based on Electron.
...
* [ryanmcdermott/clean-code-javascript (11,496s/896f)](https://github.com/ryanmcdermott/clean-code-javascript) : 🛁 Clean Code concepts adapted for JavaScript
...
* [kciter/qart.js (1,833s/61f)](https://github.com/kciter/qart.js) : Generate artistic QR code. 🎨
...
* [vapor/vapor (8,582s/483f)](https://github.com/vapor/vapor) : A web framework and server for Swift that works on macOS and Ubuntu.
...
* [lhc70000/iina (4,263s/246f)](https://github.com/lhc70000/iina) : The modern video player for macOS.
...
* [ijoshsmith/equatable-code-generator (44s/0f)](https://github.com/ijoshsmith/equatable-code-generator) : A Swift utility function that generates Equatable protocol code for any object.
