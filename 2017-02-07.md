...
#### javascript
* [freeCodeCamp/freeCodeCamp (229,935s/9,342f)](https://github.com/freeCodeCamp/freeCodeCamp) : The https://freeCodeCamp.com open source codebase and curriculum. Learn to code and help nonprofits.
* [bodymovin/bodymovin (3,862s/226f)](https://github.com/bodymovin/bodymovin) : after effects to html library
* [mxstbr/micro-github (343s/14f)](https://github.com/mxstbr/micro-github) : A tiny microservice that makes adding authentication with GitHub to your application easy.
* [vuejs/vue (41,944s/5,205f)](https://github.com/vuejs/vue) : A progressive, incrementally-adoptable JavaScript framework for building UI on the web.
* [chvin/react-tetris (1,734s/194f)](https://github.com/chvin/react-tetris) : Use React, Redux, Immutable to code Tetris.
* [hackjutsu/Lepton (557s/31f)](https://github.com/hackjutsu/Lepton) : An AWESOME desktop Gist client based on Electron.
...
* [facebookincubator/create-react-app (20,002s/2,236f)](https://github.com/facebookincubator/create-react-app) : Create React apps with no build configuration.
...
* [mzabriskie/axios (13,067s/681f)](https://github.com/mzabriskie/axios) : Promise based HTTP client for the browser and node.js
* [twbs/bootstrap (106,405s/48,419f)](https://github.com/twbs/bootstrap) : The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
* [d3/d3 (59,966s/16,003f)](https://github.com/d3/d3) : Bring data to life with SVG, Canvas and HTML. 📊📈🎉
...
* [facebook/react-native (43,687s/10,046f)](https://github.com/facebook/react-native) : A framework for building native apps with React.
...
* [pubkey/rxdb (3,102s/82f)](https://github.com/pubkey/rxdb) : 💻 📱 Client-Side Database for Browsers, NodeJS, electron, cordova, react-native and every other javascript-runtime ❗️
* [rpgtkoolmv/corescript (65s/5f)](https://github.com/rpgtkoolmv/corescript) : 

#### python
* [vesche/basicRAT (408s/59f)](https://github.com/vesche/basicRAT) : python remote access trojan
* [kylemcdonald/FreeWifi (1,545s/86f)](https://github.com/kylemcdonald/FreeWifi) : How to get free wifi.
* [wal-e/wal-e (1,937s/210f)](https://github.com/wal-e/wal-e) : Continuous Archiving for Postgres
* [martinarjovsky/WassersteinGAN (509s/80f)](https://github.com/martinarjovsky/WassersteinGAN) : 
...
* [django/django (23,689s/9,591f)](https://github.com/django/django) : The Web framework for perfectionists with deadlines.
...
* [rg3/youtube-dl (23,485s/4,496f)](https://github.com/rg3/youtube-dl) : Command-line program to download videos from YouTube.com and other video sites
...
* [fchollet/keras (11,852s/3,962f)](https://github.com/fchollet/keras) : Deep Learning library for Python. Convnets, recurrent neural networks, and more. Runs on Theano or TensorFlow.
...
* [scikit-learn/scikit-learn (16,284s/9,038f)](https://github.com/scikit-learn/scikit-learn) : scikit-learn: machine learning in Python
...
* [tmuxinator/tmuxinator (6,240s/408f)](https://github.com/tmuxinator/tmuxinator) : Manage complex tmux sessions easily
...
* [sinatra/sinatra (8,663s/1,625f)](https://github.com/sinatra/sinatra) : Classy web-development dressed in a DSL (official / canonical repo)
...
* [fastred/IBAnalyzer (533s/8f)](https://github.com/fastred/IBAnalyzer) : Find common xib and storyboard-related problems without running your app or writing unit tests.
* [remirobert/Dotzu (174s/5f)](https://github.com/remirobert/Dotzu) : iOS app debugger while using the app. Crash report, logs, network.
* [xmartlabs/Xniffer (236s/9f)](https://github.com/xmartlabs/Xniffer) : A swift network profiler built on top URLSession.
...
* [patchthecode/JTAppleCalendar (2,020s/177f)](https://github.com/patchthecode/JTAppleCalendar) : The Unofficial Swift Apple Calendar Library. View. Control. for iOS & tvOS
* [aslanyanhaik/Quick-Chat (557s/51f)](https://github.com/aslanyanhaik/Quick-Chat) : Real time chat app written in Swift 3 using Firebase
* [lhc70000/iina (4,265s/246f)](https://github.com/lhc70000/iina) : The modern video player for macOS.
...
* [CosmicMind/Motion (89s/3f)](https://github.com/CosmicMind/Motion) : Seamless animations and transitions in Swift.
...
* [dkhamsing/open-source-ios-apps (12,032s/2,166f)](https://github.com/dkhamsing/open-source-ios-apps) : 📱 Collaborative List of Open-Source iOS Apps
...
#### go
* [asciimoo/wuzz (2,770s/75f)](https://github.com/asciimoo/wuzz) : Interactive cli tool for HTTP inspection
...
* [golang/go (24,451s/3,298f)](https://github.com/golang/go) : The Go programming language
* [docker/docker (39,446s/11,815f)](https://github.com/docker/docker) : Docker - the open-source application container engine
* [murlokswarm/app (1,230s/32f)](https://github.com/murlokswarm/app) : Package to create apps with GO, HTML and CSS.
* [getlantern/lantern (22,027s/5,714f)](https://github.com/getlantern/lantern) : 🏮 Open Internet for everyone. Lantern is a free application that delivers fast, reliable and secure access to the open Internet for users in censored regions. It uses a variety of techniques to stay unblocked, including domain fronting, p2p, and pluggable transports.
...
* [mitchellh/pointerstructure (77s/3f)](https://github.com/mitchellh/pointerstructure) : Go library for addressing and reading/writing a specific value within any Go structure using a string syntax.
...
* [avelino/awesome-go (18,048s/2,271f)](https://github.com/avelino/awesome-go) : A curated list of awesome Go frameworks, libraries and software
* [drone/drone (8,601s/991f)](https://github.com/drone/drone) : Drone is a Continuous Delivery platform built on Docker, written in Go
...
* [fission/fission (1,355s/54f)](https://github.com/fission/fission) : Fast Serverless Functions for Kubernetes
...
* [coreos/etcd (12,214s/2,239f)](https://github.com/coreos/etcd) : Distributed reliable key-value store for the most critical data of a distributed system
...
#### objective-c
* [airbnb/lottie-ios (4,162s/239f)](https://github.com/airbnb/lottie-ios) : An iOS library to natively render After Effects vector animations
...
* [realm/realm-cocoa (9,843s/1,229f)](https://github.com/realm/realm-cocoa) : Realm is a mobile database: a replacement for Core Data & SQLite
...
* [rs/SDWebImage (16,787s/4,622f)](https://github.com/rs/SDWebImage) : Asynchronous image downloader with cache support as a UIImageView category
* [Flipboard/FLAnimatedImage (5,271s/821f)](https://github.com/Flipboard/FLAnimatedImage) : Performant animated GIF engine for iOS
