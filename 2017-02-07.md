...
#### objective-c
* [airbnb/lottie-ios (4,172s/241f)](https://github.com/airbnb/lottie-ios) : An iOS library to natively render After Effects vector animations
...
* [google/yapf (4,312s/291f)](https://github.com/google/yapf) : A formatter for Python files
...
* [pytorch/pytorch (2,945s/274f)](https://github.com/pytorch/pytorch) : Tensors and Dynamic neural networks in Python with strong GPU acceleration
...
#### javascript
* [freeCodeCamp/freeCodeCamp (229,939s/9,343f)](https://github.com/freeCodeCamp/freeCodeCamp) : The https://freeCodeCamp.com open source codebase and curriculum. Learn to code and help nonprofits.
* [bodymovin/bodymovin (3,864s/226f)](https://github.com/bodymovin/bodymovin) : after effects to html library
...
* [chvin/react-tetris (1,735s/195f)](https://github.com/chvin/react-tetris) : Use React, Redux, Immutable to code Tetris.
* [hackjutsu/Lepton (563s/31f)](https://github.com/hackjutsu/Lepton) : An AWESOME desktop Gist client based on Electron.
...
* [facebookincubator/create-react-app (20,004s/2,236f)](https://github.com/facebookincubator/create-react-app) : Create React apps with no build configuration.
...
#### go
* [asciimoo/wuzz (2,781s/75f)](https://github.com/asciimoo/wuzz) : Interactive cli tool for HTTP inspection
...
* [golang/go (24,453s/3,298f)](https://github.com/golang/go) : The Go programming language
* [docker/docker (39,447s/11,815f)](https://github.com/docker/docker) : Docker - the open-source application container engine
...
* [remirobert/Dotzu (181s/5f)](https://github.com/remirobert/Dotzu) : iOS app debugger while using the app. Crash report, logs, network.
...
* [patchthecode/JTAppleCalendar (2,030s/178f)](https://github.com/patchthecode/JTAppleCalendar) : The Unofficial Swift Apple Calendar Library. View. Control. for iOS & tvOS
