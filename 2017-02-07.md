...
#### go
* [asciimoo/wuzz (2,754s/73f)](https://github.com/asciimoo/wuzz) : Interactive cli tool for HTTP inspection
...
* [mitchellh/pointerstructure (76s/3f)](https://github.com/mitchellh/pointerstructure) : Go library for addressing and reading/writing a specific value within any Go structure using a string syntax.
...
* [jochasinga/RxGo (467s/11f)](https://github.com/jochasinga/RxGo) : Reactive Extensions for the Go language.
...
* [coreos/etcd (12,214s/2,240f)](https://github.com/coreos/etcd) : Distributed reliable key-value store for the most critical data of a distributed system
...
#### javascript
* [freeCodeCamp/freeCodeCamp (229,930s/9,342f)](https://github.com/freeCodeCamp/freeCodeCamp) : The https://freeCodeCamp.com open source codebase and curriculum. Learn to code and help nonprofits.
* [bodymovin/bodymovin (3,859s/226f)](https://github.com/bodymovin/bodymovin) : after effects to html library
* [mxstbr/micro-github (343s/13f)](https://github.com/mxstbr/micro-github) : A tiny microservice that makes adding authentication with GitHub to your application easy.
...
* [ivanseidel/Is-Now-Illegal (989s/71f)](https://github.com/ivanseidel/Is-Now-Illegal) : A NERD protest against Trump's Immigration ban
...
* [facebookincubator/create-react-app (20,000s/2,236f)](https://github.com/facebookincubator/create-react-app) : Create React apps with no build configuration.
* [airbnb/javascript (47,000s/9,021f)](https://github.com/airbnb/javascript) : JavaScript Style Guide
...
* [ro31337/libretaxi (2,216s/282f)](https://github.com/ro31337/libretaxi) : LibreTaxi, free and open source Uber/Lyft alternative to connect passengers and drivers.
...
* [webpack/webpack (23,956s/2,804f)](https://github.com/webpack/webpack) : A bundler for javascript and friends. Packs many modules into a few bundled assets. Code Splitting allows to load parts for the application on demand. Through "loaders," modules can be CommonJs, AMD, ES6 modules, CSS, Images, JSON, Coffeescript, LESS, ... and your custom stuff.
...
* [rpgtkoolmv/corescript (64s/5f)](https://github.com/rpgtkoolmv/corescript) : 

#### objective-c
* [airbnb/lottie-ios (4,153s/239f)](https://github.com/airbnb/lottie-ios) : An iOS library to natively render After Effects vector animations
...
* [shaojiankui/ProfilesManager (85s/17f)](https://github.com/shaojiankui/ProfilesManager) : iOS Provisioning Profiles, .mobileprovision files manager tool for mac
* [kpwn/yalu102 (1,165s/389f)](https://github.com/kpwn/yalu102) : incomplete iOS 10.2 jailbreak for 64 bit devices by qwertyoruiopz and marcograssi
...
* [remirobert/Dotzu (171s/5f)](https://github.com/remirobert/Dotzu) : iOS app debugger while using the app. Crash report, logs, network.
...
* [CosmicMind/Motion (87s/3f)](https://github.com/CosmicMind/Motion) : Seamless animations and transitions in Swift.
...
* [danielgindi/Charts (12,875s/2,304f)](https://github.com/danielgindi/Charts) : Beautiful charts for iOS/tvOS/OSX! The Apple side of the crossplatform MPAndroidChart.
...
* [kylemcdonald/FreeWifi (1,541s/85f)](https://github.com/kylemcdonald/FreeWifi) : How to get free wifi.
