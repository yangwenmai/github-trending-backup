...
#### objective-c
* [airbnb/lottie-ios (4,164s/240f)](https://github.com/airbnb/lottie-ios) : An iOS library to natively render After Effects vector animations
...
* [firebase/quickstart-ios (498s/323f)](https://github.com/firebase/quickstart-ios) : Firebase Quickstart Samples for iOS
...
#### go
* [asciimoo/wuzz (2,774s/75f)](https://github.com/asciimoo/wuzz) : Interactive cli tool for HTTP inspection
...
* [mitchellh/pointerstructure (78s/3f)](https://github.com/mitchellh/pointerstructure) : Go library for addressing and reading/writing a specific value within any Go structure using a string syntax.
...
* [spf13/hugo (14,713s/2,189f)](https://github.com/spf13/hugo) : A Fast and Flexible Static Site Generator built with love in GoLang
...
* [kylemcdonald/FreeWifi (1,546s/86f)](https://github.com/kylemcdonald/FreeWifi) : How to get free wifi.
* [wal-e/wal-e (1,937s/211f)](https://github.com/wal-e/wal-e) : Continuous Archiving for Postgres
* [martinarjovsky/WassersteinGAN (510s/80f)](https://github.com/martinarjovsky/WassersteinGAN) : 
...
* [django/django (23,689s/9,592f)](https://github.com/django/django) : The Web framework for perfectionists with deadlines.
...
#### swift
* [oarrabi/Guaka (703s/13f)](https://github.com/oarrabi/Guaka) : The smartest and most beautiful (POSIX compliant) Command line framework for Swift 🤖
...
* [remirobert/Dotzu (176s/5f)](https://github.com/remirobert/Dotzu) : iOS app debugger while using the app. Crash report, logs, network.
* [xmartlabs/Xniffer (237s/9f)](https://github.com/xmartlabs/Xniffer) : A swift network profiler built on top URLSession.
...
* [patchthecode/JTAppleCalendar (2,023s/178f)](https://github.com/patchthecode/JTAppleCalendar) : The Unofficial Swift Apple Calendar Library. View. Control. for iOS & tvOS
...
* [lhc70000/iina (4,266s/246f)](https://github.com/lhc70000/iina) : The modern video player for macOS.
...
* [CosmicMind/Motion (92s/3f)](https://github.com/CosmicMind/Motion) : Seamless animations and transitions in Swift.
...
* [dkhamsing/open-source-ios-apps (12,034s/2,166f)](https://github.com/dkhamsing/open-source-ios-apps) : 📱 Collaborative List of Open-Source iOS Apps
...
#### javascript
* [freeCodeCamp/freeCodeCamp (229,937s/9,342f)](https://github.com/freeCodeCamp/freeCodeCamp) : The https://freeCodeCamp.com open source codebase and curriculum. Learn to code and help nonprofits.
...
* [hackjutsu/Lepton (561s/31f)](https://github.com/hackjutsu/Lepton) : An AWESOME desktop Gist client based on Electron.
...
* [ryanmcdermott/clean-code-javascript (11,498s/896f)](https://github.com/ryanmcdermott/clean-code-javascript) : 🛁 Clean Code concepts adapted for JavaScript
...
* [facebook/react-native (43,688s/10,046f)](https://github.com/facebook/react-native) : A framework for building native apps with React.
* [JosephusPaye/Keen-UI (2,081s/180f)](https://github.com/JosephusPaye/Keen-UI) : A lightweight collection of essential UI components written with Vue and inspired by Material Design
...
* [jondot/awesome-react-native (10,027s/1,213f)](https://github.com/jondot/awesome-react-native) : An "awesome" type curated list of React Native components, news, tools, and learning material
