...
#### swift
* [lkzhao/Hero (2,101s/71f)](https://github.com/lkzhao/Hero) : Supercharged transition engine for iOS.
* [krzysztofzablocki/Traits (251s/8f)](https://github.com/krzysztofzablocki/Traits) : Modify your native iOS app in real time.
...
* [ayush1997/Xvision (64s/21f)](https://github.com/ayush1997/Xvision) : Chest Xray image analysis using Deep learning !
* [ansible/ansible (20,585s/6,452f)](https://github.com/ansible/ansible) : Ansible is a radically simple IT automation platform that makes your applications and systems easier to deploy. Avoid writing scripts or custom code to deploy and update your applications— automate in a language that approaches plain English, using SSH, with no agents to install on remote systems.
...
* [django/django (22,943s/9,269f)](https://github.com/django/django) : The Web framework for perfectionists with deadlines.
* [gboeing/osmnx (243s/22f)](https://github.com/gboeing/osmnx) : Python for street networks: retrieve, construct, analyze, and visualize street networks from OpenStreetMap.
...
#### objective-c
* [QMUI/QMUI_iOS (726s/82f)](https://github.com/QMUI/QMUI_iOS) : QMUI iOS——致力于提高项目 UI 开发效率的解决方案
...
* [driusan/dainit (108s/3f)](https://github.com/driusan/dainit) : A simple pure-Go Linux init system
...
* [pressly/chi (1,086s/61f)](https://github.com/pressly/chi) : lightweight, idiomatic and composable router for building Go 1.7+ HTTP services
...
* [cloudson/gitql (4,363s/106f)](https://github.com/cloudson/gitql) : A git query language
...
* [amilajack/eslint-plugin-compat (599s/9f)](https://github.com/amilajack/eslint-plugin-compat) : Lint browser compatability of APIs used
...
* [tinytacoteam/zazu (276s/14f)](https://github.com/tinytacoteam/zazu) : 🚀 Cross platform productivity tool.
...
* [espadrine/Solve-Data-In-Code (1,269s/71f)](https://github.com/espadrine/Solve-Data-In-Code) : Computer Science Cheatsheets.
...
* [chmln/flatpickr (5,118s/296f)](https://github.com/chmln/flatpickr) : lightweight and powerful datetimepicker with no dependencies
...
* [facebook/react (56,966s/10,276f)](https://github.com/facebook/react) : A declarative, efficient, and flexible JavaScript library for building user interfaces.
...
* [d3/d3 (58,734s/15,675f)](https://github.com/d3/d3) : Bring data to life with SVG, Canvas and HTML. 📊📈🎉
