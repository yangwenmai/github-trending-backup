...
* [keybase/client (1,088s/94f)](https://github.com/keybase/client) : Keybase Go Library, Client, Service, OS X, iOS, Android, Electron
...
* [eliukblau/pixterm (82s/4f)](https://github.com/eliukblau/pixterm) : Draw images in your ANSI terminal with true color
...
* [mattn/memo (41s/2f)](https://github.com/mattn/memo) : 📓 Memo Life For You
...
#### python
* [getredash/redash (4,189s/646f)](https://github.com/getredash/redash) : Make Your Company Data Driven. Connect to any data source, easily visualize and share your data.
* [tensorflow/fold (505s/30f)](https://github.com/tensorflow/fold) : Deep learning with dynamic computation graphs in TensorFlow
* [airbnb/superset (11,264s/1,403f)](https://github.com/airbnb/superset) : Superset is a data exploration platform designed to be visual, intuitive, and interactive
...
#### objective-c
* [airbnb/lottie-ios (4,863s/323f)](https://github.com/airbnb/lottie-ios) : An iOS library to natively render After Effects vector animations
* [shaojiankui/ProfilesManager (219s/25f)](https://github.com/shaojiankui/ProfilesManager) : iOS Provisioning Profiles, .mobileprovision files manager tool for mac
...
#### javascript
* [freeCodeCamp/freeCodeCamp (230,721s/9,385f)](https://github.com/freeCodeCamp/freeCodeCamp) : The https://freeCodeCamp.com open source codebase and curriculum. Learn to code and help nonprofits.
* [bdash-app/bdash (509s/17f)](https://github.com/bdash-app/bdash) : A simple business intelligence application.
* [eggjs/egg (1,157s/91f)](https://github.com/eggjs/egg) : Born to build better enterprise frameworks and apps with Node.js & koa
* [dli/paint (519s/28f)](https://github.com/dli/paint) : Fluid Paint - http://david.li/paint
* [vuejs/vue (42,260s/5,274f)](https://github.com/vuejs/vue) : A progressive, incrementally-adoptable JavaScript framework for building UI on the web.
...
* [bodymovin/bodymovin (4,197s/243f)](https://github.com/bodymovin/bodymovin) : after effects to html library
* [WhitestormJS/whitestorm.js (2,867s/134f)](https://github.com/WhitestormJS/whitestorm.js) : 🚀 🌪 Super-fast 3D framework for Web Applications 🥇 & Games 🎮. Based on Three.js
* [cyclejs-community/redux-cycles (191s/4f)](https://github.com/cyclejs-community/redux-cycles) : Bring functional reactive programming to Redux using Cycle.js
...
* [ryanmcdermott/clean-code-javascript (11,646s/912f)](https://github.com/ryanmcdermott/clean-code-javascript) : 🛁 Clean Code concepts adapted for JavaScript
...
* [serverless/scope (66s/1f)](https://github.com/serverless/scope) : Scope - Customizable birdeye's view of your Github project
...
#### swift
* [soapyigu/Swift30Projects (976s/130f)](https://github.com/soapyigu/Swift30Projects) : 30 mini Swift Apps
...
* [netyouli/WHC_Scan (89s/11f)](https://github.com/netyouli/WHC_Scan) : 高效强大扫描分析iOS和Android项目里没有使用的类Mac开源工具，清理项目垃圾类，让项目结构干净清爽，升级维护得心应手
...
* [dennisweissmann/DeviceKit (829s/81f)](https://github.com/dennisweissmann/DeviceKit) : DeviceKit is a value-type replacement of UIDevice.
