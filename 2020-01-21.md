...
#### Python
* [tensortrade-org/tensortrade (990s/240f)](https://github.com/tensortrade-org/tensortrade) : An open source reinforcement learning framework for training, evaluating, and deploying robust trading agents.
...
* [baowenbo/DAIN (611s/70f)](https://github.com/baowenbo/DAIN) : Depth-Aware Video Frame Interpolation (CVPR 2019)
...
* [scikit-learn/scikit-learn (39,025s/19,057f)](https://github.com/scikit-learn/scikit-learn) : scikit-learn: machine learning in Python
* [bregman-arie/devops-exercises (3,665s/398f)](https://github.com/bregman-arie/devops-exercises) : Linux, Jenkins, AWS, SRE, Prometheus, Docker, Python, Ansible, Git, Kubernetes, Terraform, OpenStack, SQL, NoSQL, Azure, GCP, DNS, Elastic, Network, Virtualization
...
#### Java
* [theonedev/onedev (1,814s/75f)](https://github.com/theonedev/onedev) : Super Easy All-In-One DevOps Platform
* [bephrem1/backtobackswe (1,023s/386f)](https://github.com/bephrem1/backtobackswe) : Code Examples For Back To Back SWE Lessons
* [phodal/migration (1,230s/154f)](https://github.com/phodal/migration) : 《系统重构与迁移指南》手把手教你分析、评估现有系统、制定重构策略、探索可行重构方案、搭建测试防护网、进行系统架构重构、服务架构重构、模块重构、代码重构、数据库重构、重构后的架构守护
...
* [testcontainers/testcontainers-java (3,320s/626f)](https://github.com/testcontainers/testcontainers-java) : Testcontainers is a Java library that supports JUnit tests, providing lightweight, throwaway instances of common databases, Selenium web browsers, or anything else that can run in a Docker container.
* [oracle/graal (11,637s/771f)](https://github.com/oracle/graal) : GraalVM: Run Programs Faster Anywhere 🚀
* [CyC2018/CS-Notes (89,359s/28,800f)](https://github.com/CyC2018/CS-Notes) : 📚 技术面试必备基础知识、Leetcode、计算机操作系统、计算机网络、系统设计、Java、Python、C++
...
* [material-components/material-components-android (9,129s/1,565f)](https://github.com/material-components/material-components-android) : Modular and customizable Material Design UI components for Android
...
* [apache/avro (1,470s/979f)](https://github.com/apache/avro) : Apache Avro
...
* [eugenp/tutorials (19,120s/29,448f)](https://github.com/eugenp/tutorials) : Just Announced - "Learn Spring Security OAuth":
...
#### Rust
* [dani-garcia/bitwarden_rs (2,681s/177f)](https://github.com/dani-garcia/bitwarden_rs) : Unofficial Bitwarden compatible server written in Rust
* [actix/actix-web (6,723s/946f)](https://github.com/actix/actix-web) : Actix web is a small, pragmatic, and extremely fast rust web framework.
...
* [tanakh/cargo-atcoder (99s/2f)](https://github.com/tanakh/cargo-atcoder) : Cargo subcommand for AtCoder
* [BurntSushi/xsv (5,445s/177f)](https://github.com/BurntSushi/xsv) : A fast CSV command line toolkit written in Rust.
* [rust-lang/rust (41,948s/6,423f)](https://github.com/rust-lang/rust) : Empowering everyone to build reliable and efficient software.
* [seanmonstar/warp (1,558s/155f)](https://github.com/seanmonstar/warp) : A super-easy, composable, web server framework for warp speeds.
...
* [servo/servo (15,423s/2,305f)](https://github.com/servo/servo) : The Servo Browser Engine
* [steadylearner/Rust-Full-Stack (126s/8f)](https://github.com/steadylearner/Rust-Full-Stack) : Easily testable and working Rust codes with blog posts to explain them.
...
* [gotham-rs/gotham (1,526s/99f)](https://github.com/gotham-rs/gotham) : A flexible web framework that promotes stability, safety, security and speed.
...
* [clap-rs/clap (3,605s/359f)](https://github.com/clap-rs/clap) : A full featured, fast Command Line Argument Parser for Rust
...
#### HTML
* [collabnix/kubelabs (402s/43f)](https://github.com/collabnix/kubelabs) : Kubernetes - Beginners | Intermediate | Advanced
* [Igglybuff/awesome-piracy (8,538s/808f)](https://github.com/Igglybuff/awesome-piracy) : A curated list of awesome warez and piracy links
...
* [lipis/flag-icon-css (6,404s/915f)](https://github.com/lipis/flag-icon-css) : 🎏 A collection of all country flags in SVG — plus the CSS for easier integration
...
* [jeromeetienne/AR.js (14,500s/1,988f)](https://github.com/jeromeetienne/AR.js) : Efficient Augmented Reality for the Web - 60fps on mobile!
...
* [google/material-design-icons (39,544s/8,123f)](https://github.com/google/material-design-icons) : Material Design icons by Google
...
* [mmistakes/minimal-mistakes (6,061s/10,213f)](https://github.com/mmistakes/minimal-mistakes) : 📐 Jekyll theme for building a personal site, blog, project documentation, or portfolio.
...
* [Huxpro/huxpro.github.io (4,959s/3,530f)](https://github.com/Huxpro/huxpro.github.io) : My Blog / Jekyll Themes / PWA
* [opencodeiiita/Portal (6s/16f)](https://github.com/opencodeiiita/Portal) : Resource sharing platform
...
#### JavaScript
* [gothinkster/realworld (35,250s/2,642f)](https://github.com/gothinkster/realworld) : "The mother of all demo apps" — Exemplary fullstack Medium.com clone powered by React, Angular, Node, Django, and many more 🏅
* [ryanmcdermott/clean-code-javascript (30,843s/3,556f)](https://github.com/ryanmcdermott/clean-code-javascript) : 🛁 Clean Code concepts adapted for JavaScript
* [cube-js/cube.js (6,974s/424f)](https://github.com/cube-js/cube.js) : 📊 Cube.js - Open Source Analytics Framework
* [trekhleb/javascript-algorithms (60,857s/9,818f)](https://github.com/trekhleb/javascript-algorithms) : 📝 Algorithms and data structures implemented in JavaScript with explanations and links to further readings
...
* [facebook/create-react-app (75,384s/17,859f)](https://github.com/facebook/create-react-app) : Set up a modern web app by running one command.
* [hakimel/reveal.js (49,952s/14,484f)](https://github.com/hakimel/reveal.js) : The HTML Presentation Framework
* [vuejs/vue-router (15,513s/4,201f)](https://github.com/vuejs/vue-router) : 🚦 The official router for Vue.js.
...
* [typicode/json-server (45,033s/4,141f)](https://github.com/typicode/json-server) : Get a full fake REST API with zero coding in less than 30 seconds (seriously)
...
* [jgraph/drawio-desktop (4,838s/523f)](https://github.com/jgraph/drawio-desktop) : Official electron build of draw.io
...
* [NARKOZ/hacker-scripts (37,236s/6,190f)](https://github.com/NARKOZ/hacker-scripts) : Based on a true story
...
* [mui-org/material-ui (53,822s/14,036f)](https://github.com/mui-org/material-ui) : React components for faster and easier web development. Build your own design system, or start with Material Design.
* [facebook/react-native (84,285s/18,833f)](https://github.com/facebook/react-native) : A framework for building native apps with React.
...
#### Objective-C
* [sdlpal/sdlpal (907s/178f)](https://github.com/sdlpal/sdlpal) : SDL-based reimplementation of the classic Chinese-language RPG "Xiān jiàn Qí Xiá Zhuàn" (also known as PAL).
...
* [expo/expo (8,540s/1,216f)](https://github.com/expo/expo) : An open-source platform for making universal native apps with React. Expo runs on Android, iOS, and the web.
...
* [facebook/Shimmer (9,162s/1,104f)](https://github.com/facebook/Shimmer) : An easy way to add a simple, shimmering effect to any view in an iOS app.
...
#### Go
* [gin-gonic/gin (34,909s/4,024f)](https://github.com/gin-gonic/gin) : Gin is a HTTP web framework written in Go (Golang). It features a Martini-like API with much better performance -- up to 40 times faster. If you need smashing performance, get yourself some Gin.
* [ipfs/go-ipfs (9,205s/1,668f)](https://github.com/ipfs/go-ipfs) : IPFS implementation in Go
* [hashicorp/terraform (20,401s/5,395f)](https://github.com/hashicorp/terraform) : Terraform enables you to safely and predictably create, change, and improve infrastructure. It is an open source tool that codifies APIs into declarative configuration files that can be shared amongst team members, treated as code, edited, reviewed, and versioned.
* [tektoncd/pipeline (4,290s/632f)](https://github.com/tektoncd/pipeline) : A K8s-native Pipeline resource.
* [golang/go (68,172s/9,692f)](https://github.com/golang/go) : The Go programming language
* [rancher/k3s (11,239s/792f)](https://github.com/rancher/k3s) : Lightweight Kubernetes. 5 less than k8s.
...
#### Vue
* [liyasthomas/postwoman (15,768s/898f)](https://github.com/liyasthomas/postwoman) : 👽 API request builder - A free, fast and beautiful alternative to Postman https://postwoman.io 🔥
...
* [xaksis/vue-good-table (1,216s/251f)](https://github.com/xaksis/vue-good-table) : An easy to use powerful data table for vuejs with advanced customizations including sorting, column filtering, pagination, grouping etc
...
#### TypeScript
* [denoland/deno (41,248s/1,913f)](https://github.com/denoland/deno) : A secure JavaScript and TypeScript runtime
...
* [angular/angular (56,614s/15,584f)](https://github.com/angular/angular) : One framework. Mobile & desktop.
...
* [yarnpkg/berry (1,360s/125f)](https://github.com/yarnpkg/berry) : 📦🐈 The active development trunk for Yarn 2 ⚒
...
* [ionic-team/ionic (40,062s/13,156f)](https://github.com/ionic-team/ionic) : Build amazing Native and Progressive Web Apps with web technologies. One app running on everything 🎉
...
* [ReactiveX/rxjs (20,901s/2,179f)](https://github.com/ReactiveX/rxjs) : A reactive programming library for JavaScript
